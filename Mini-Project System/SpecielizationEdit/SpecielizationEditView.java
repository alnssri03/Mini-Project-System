...
import javax.swing.*;
/*
 * SpecielizationEditView.java
 * 
 * This class implements the GUI componets related to the Specielization Edit page in the system.
 * 
 * Used design : MVC pattern
 * 
 */
public class SpecielizationEditView extends javax.swing.JFrame {
    ...
    private SpecielizationEditController controller;
    private  int selected;

    public SpecielizationEditView( int selected) {
        this. selected = selected;
        initComponents();
        controller = new SpecielizationEditController(this);
    ...
    public void setCreateButton(javax.swing.JButton editButton) {
    ...
    public SpecielizationEditController getController() {
        return this.controller;
    }

    public void setController(SpecielizationEditController controller) {
